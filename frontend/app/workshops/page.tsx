...
export default function WorkshopsPortal() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
      ...
      {/* Call to Action */}
      <section className="py-16 px-4 mt-16 bg-gradient-to-r from-purple-100 to-blue-100 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <span className="px-4 py-1 bg-white/60 text-purple-700 rounded-full text-sm font-medium inline-block mb-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="px-6 py-3 bg-white text-purple-700 font-semibold rounded-full hover:bg-gray-100 transition-colors">
              Learn More
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="flex gap-4">
              <a href="#" className="h-10 w-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-purple-500 transition-colors duration-200">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/workshops" className="text-gray-400 hover:text-purple-400 transition-colors duration-200">Workshops</Link></li>
              <li><Link href="/events" className="text-gray-400 hover:text-purple-400 transition-colors duration-200">Events</Link></li>
              <li><Link href="/courses" className="text-gray-400 hover:text-purple-400 transition-colors duration-200">Courses</Link></li>
              <li><Link href="/jobs-portal" className="text-gray-400 hover:text-purple-400 transition-colors duration-200">Jobs</Link></li>
              <li><Link href="/login" className="text-gray-400 hover:text-purple-400 transition-colors duration-200">Login</Link></li>
              <li><Link href="/register" className="text-gray-400 hover:text-purple-400 transition-colors duration-200">Register</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              ...
              <li>
                <button className="mt-2 px-4 py-2 bg-purple-500 text-white rounded-md hover:bg-purple-600 transition-colors duration-200">
                  Contact Support
                </button>
              </li>
            </ul>
