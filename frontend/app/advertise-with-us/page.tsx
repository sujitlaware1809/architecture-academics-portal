        ...
        <div className="max-w-5xl mx-auto">
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card className="border-2 border-gray-100 bg-white hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                <CardHeader className="text-center pb-4">
                  <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center mx-auto mb-4 shadow-lg">
                ...
                <CardContent className="text-center">
                  ...
                  <Badge variant="secondary" className="bg-cyan-100 text-cyan-700">Coming Soon</Badge>
                </CardContent>
              </Card>
            ...
            <div className="text-center mt-8">
              <p className="text-gray-600">
                Interested in early partnership opportunities? <a href="#contact-form" className="text-blue-600 font-medium hover:text-blue-700 transition-colors">Contact us</a> to be notified when these become available.
              </p>
            </div>
          </section>
          ...
          <section className="mb-16">
            ...
            <div className="mt-10 p-8 border-2 border-gray-100 rounded-2xl bg-gradient-to-br from-gray-50 to-white">
              <div className="text-center">
                ...
                <Button variant="outline" className="border-2 border-blue-600 text-blue-600 hover:bg-blue-50" asChild>
          ...
          {/* Direct Contact */}
          <section className="mt-12 text-center bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-2xl border border-blue-100">
            ...
            <div className="space-y-2">
              <p>
                <a href="mailto:partnerships@architectureacademics.com" className="text-blue-600 font-medium hover:text-blue-700 transition-colors">
                  partnerships@architectureacademics.com
                </a>
              </p>
              <p>
                <a href="tel:+919876543210" className="text-blue-600 font-medium hover:text-blue-700 transition-colors">
                  +91 98765 43210
                </a>
              </p>
            </div>
      ...
      <footer className="bg-gradient-to-r from-gray-900 via-slate-900 to-gray-900 text-white py-12 mt-16">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              <h4 className="text-lg font-medium mb-4 text-blue-300">Quick Links</h4>
              <ul className="space-y-2">
                <li><Link href="/" className="text-gray-300 hover:text-blue-300 transition-colors">Home</Link></li>
                <li><Link href="/courses" className="text-gray-300 hover:text-blue-300 transition-colors">Courses</Link></li>
                <li><Link href="/events" className="text-gray-300 hover:text-blue-300 transition-colors">Events</Link></li>
                <li><Link href="/login" className="text-gray-300 hover:text-blue-300 transition-colors">Login</Link></li>
              </ul>
            </div>
            
            <div>
              <h4 className="text-lg font-medium mb-4 text-blue-300">Partnership</h4>
              <ul className="space-y-2">
                <li><Link href="/advertise-with-us" className="text-gray-300 hover:text-blue-300 transition-colors">Partner With Us</Link></li>
                <li><Link href="#" className="text-gray-300 hover:text-blue-300 transition-colors">Early Partners</Link></li>
                <li><Link href="/contact-us" className="text-gray-300 hover:text-blue-300 transition-colors">Contact Us</Link></li>
                <li><Link href="#" className="text-gray-300 hover:text-blue-300 transition-colors">Media Kit</Link></li>
              </ul>
            </div>
            
            <div>
              <h4 className="text-lg font-medium mb-4 text-blue-300">Connect With Us</h4>
