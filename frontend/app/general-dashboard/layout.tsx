...
export default function GeneralDashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const sidebarItems = [
    ...
    { name: "Explore", href: "/general-dashboard/explore", icon: Search },
    { name: "Resources", href: "/general-dashboard/resources", icon: Package },
          ...
          >
            <div className="p-4 border-b border-gray-200">
              <div className="flex items-center">
                ...
                <h1 className="ml-3 text-xl font-semibold text-gray-800">General Panel</h1>
              </div>
            </div>
          ...
          {sidebarItems.map((item) => {
            ...
            return (
              <Link
                key={item.name}
                href={item.href}
                className={`group relative flex items-center ${sidebarOpen ? 'px-3' : 'justify-center'} py-2.5 text-sm font-medium rounded-lg hover:bg-purple-50 hover:text-purple-700 text-gray-600 transition-all duration-200`}
              >
