        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <p className="text-gray-500 font-medium">Manage your professional activities</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="flex flex-col items-center text-center">
              ...
              <div className="mt-2 text-sm text-gray-500">{user.profession ?? (user.user_type === 'architect' ? 'Architect' : 'Profile')}</div>
            </div>
      ...
      <div className="px-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <DashboardSection
            ...
            viewAllLink="/architect-dashboard/events"
          ...
          <DashboardSection
            ...
            viewAllLink="/architect-dashboard/workshops"
            viewAllText="View All"
            items={workshops}
            renderItem={(workshop) => (
          ...
          <DashboardSection
            ...
            viewAllLink="/architect-dashboard/jobs"
            viewAllText="View All"
            items={jobs}
            renderItem={(job) => (
          ...
          <DashboardSection
            ...
            viewAllLink="/architect-dashboard/discussions"
            viewAllText="View All"
            items={discussions}
