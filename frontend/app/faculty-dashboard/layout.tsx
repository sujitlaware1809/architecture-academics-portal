...
export default function FacultyDashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const sidebarItems = [
    ...
    { name: "Assignments", href: "/faculty-dashboard/assignments", icon: FileText },
          ...
          >
            <div className="p-4 border-b border-gray-200">
              <div className="flex items-center">
                ...
                <h1 className="ml-3 text-xl font-semibold text-gray-800">Faculty Panel</h1>
              </div>
            </div>
              ...
              {sidebarItems.map((item) => {
                ...
                return (
                  <Link
                    key={item.name}
                    href={item.href}
                    className="flex items-center px-3 py-2 text-sm font-medium rounded-md hover:bg-indigo-50 hover:text-indigo-700 text-gray-700"
          ...
          {sidebarItems.map((item) => {
            ...
            return (
              <Link
                key={item.name}
                href={item.href}
                className={`group relative flex items-center ${sidebarOpen ? 'px-3' : 'justify-center'} py-2.5 text-sm font-medium rounded-lg hover:bg-indigo-50 hover:text-indigo-700 text-gray-600 transition-all duration-200`}
              >
