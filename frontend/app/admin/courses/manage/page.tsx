...
export default function ManageCoursesAdmin() {
  ...
  const submitMaterial = async () => {
    ...
    try {
      ...
      const data = await uploadMultipart(`${process.env.NEXT_PUBLIC_API_URL}/api/courses/${selectedCourseId}/materials/upload`, form)
  ...
  const submitVideo = async () => {
    ...
    try {
      ...
      const data = await uploadMultipart(`${process.env.NEXT_PUBLIC_API_URL}/api/courses/${selectedCourseId}/videos/upload`, form)
